...
namespace EnumTypes.Models
{
    ...
    public class StoreInitializer : DropCreateDatabaseIfModelChanges<DataContext> 
    {
        ...
        protected override void Seed(DataContext context)
        {
            ...
            v.Year = 2013;
            v.MSRP = 23700;
            v.BodyStyle = OtherClassesAndEnums.BodyStyle.Sedan;
            v.ContentType = "image/png";
            v.Photo = File.ReadAllBytes(HostingEnvironment.MapPath("~/Assets/images/2013_camry_le.png"));
            context.Vehicles.Add(v);

            v = null;
            v = new Vehicle { Model = "Camry", Trim = "SE", Year = 2013, MSRP = 26985, BodyStyle= OtherClassesAndEnums.BodyStyle.Coupe, ContentType = "image/png" };
            v.Photo = File.ReadAllBytes(HostingEnvironment.MapPath("~/Assets/images/2013_camry_se.png"));
            context.Vehicles.Add(v);

            v = null;
            v = new Vehicle { Model = "Camry", Trim = "SE V6", Year = 2013, MSRP = 29740, BodyStyle= OtherClassesAndEnums.BodyStyle.SportUtility, ContentType = "image/png" };
            v.Photo = File.ReadAllBytes(HostingEnvironment.MapPath("~/Assets/images/2013_camry_se_v6.png"));
            context.Vehicles.Add(v);

            v = null;
            v = new Vehicle { Model = "Camry", Trim = "XLE", Year = 2013, MSRP = 30470, BodyStyle= OtherClassesAndEnums.BodyStyle.Hatchback, ContentType = "image/png" };
            v.Photo = File.ReadAllBytes(HostingEnvironment.MapPath("~/Assets/images/2013_camry_xle.png"));
            context.Vehicles.Add(v);

            v = null;
            v = new Vehicle { Model = "Camry", Trim = "XLE V6", Year = 2013, MSRP = 34275, BodyStyle= OtherClassesAndEnums.BodyStyle.Pickup, ContentType = "image/png" };
