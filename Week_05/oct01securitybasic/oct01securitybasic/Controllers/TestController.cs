...
namespace oct01securitybasic.Controllers
{
    ...
    // [Authorize(Roles = "Admin,User", Users = "yourname")]
    // etc.
    ...
    public class TestController : ApiController
    {
        ...
        public string GetInfo(string info)
        {
            return string.Format("{0} | {1} | {2} | {3}",
                ...
                User.IsInRole("Admin") ? "An administrator" : "Not an administrator",
                User.IsInRole("User") ? "Standard user" : "Not a standard user");
        }
